...
if is_authenticated:
    ...
    fecha_nacimiento: datetime.date = st.date_input(
        "Fecha de Nacimiento",
    ...
    aceptar_terminos = st.checkbox(
        ...
        "servicio.")
    aceptar_privacidad = st.checkbox(
        "Al marcar esta casilla, confirmo que he leído y aceptado la "
        "política de privacidad de la aplicación.")

    # Botón para registrar al usuario
    if st.button("Registrarse"):
        # Verificar si las contraseñas coinciden y las casillas de
        # verificación están marcadas
        if (
                contrasena == confirmar_contrasena and aceptar_terminos and
                aceptar_privacidad):
            ...
            if response.status_code < 200 or response.status_code >= 300:
                ...
                st.success("Registro exitoso. ¡Bienvenido, {}!".format(
                    nombres_apellidos))
