...
| Tarea |Descripción| Responsable | Estado |  
|--|--|--|--|
| Calificaciones de libros. | Vista y funcionalidad para calificar en un sistema de puntaje los libros. Adicional agregar este campo a las vistas que lo requieran. |[Juan Camilo Montoya](https://github.com/jucamo0713) | Sin Empezar | 
| Visualizar perfiles de personas. | Vista y funcionalidad de búsqueda de otros usuarios, adicional del detalle del perfil del usuario.| [Hinara Pastora Sánchez](https://github.com/HinaraSM) | Sin Empezar | 
